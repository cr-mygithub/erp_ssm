...
public class RoleController {
    ...
    public List<TreeResultUtil> permisssionList(){
    ...
    @RequestMapping("page")
    public EasyUiResultUtil<Role> page(Role role, @RequestParam(defaultValue = "1") int pageNum, @RequestParam(defaultValue = "2") int pageSize){
